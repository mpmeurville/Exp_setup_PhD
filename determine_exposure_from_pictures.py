...
path1 = "/home/marie-pierre/Documents/PhD/ants_trophallaxis/exp_setup/setup_output/tests_default_params/upper/upper_test_exposure/"
path2 = "/home/marie-pierre/Documents/PhD/ants_trophallaxis/exp_setup/setup_output/tests_default_params/lower/lower_test_exposure/"
...
exposure = [ -7, -6, -5, -4, -3, -2, -1] # 0 means infinite
...
#    cap3 = cv2.VideoCapture(2)
    ...
    cap1.set(cv2.CAP_PROP_EXPOSURE, e)
    ...
    cap2.set(cv2.CAP_PROP_EXPOSURE, e)
...
#    cap3.set(cv2.CAP_PROP_FOCUS,f)
    ...
    while(True):
        ...
        filename1 = path1 + str(e)  + '.tiff'
        filename2 = path2 + str(e)  + '.tiff'
#        filename3 = path3 + str(f)  + '.tiff'


        print(filename1)
        print(cap1.get(cv2.CAP_PROP_EXPOSURE))
        print(cap2.get(cv2.CAP_PROP_EXPOSURE))
