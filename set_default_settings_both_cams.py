...
path1 = "/home/marie-pierre/Documents/PhD/ants_trophallaxis/exp_setup/setup_output/tests_default_params/lower/"
path2 = "/home/marie-pierre/Documents/PhD/ants_trophallaxis/exp_setup/setup_output/tests_default_params/upper/"
...
brightness = [60,80,100, 120, 130, 140,160, 180, 200, 220,240, 250] # 1 means dark
focus = [ 0, 5, 10, 15, 20, 25, 30, 35, 40, 50, 60,70, 80, 90,100] # 1 means no contrast?
contrast = [0, 60,65, 70,75, 80,85, 90,95 ,100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 210, 220, 230, 240, 250] # 0 means infinite
...
for b in brightness:
    ...
    for f in focus:
        ...
        for c in contrast:
            ...
            cap2 = cv2.VideoCapture(5) # video capture source camera (Here webcam of laptop)
...
#    cap3.set(cv2.CAP_PROP_FOCUS,f)
            ...
            while(True):
                ...
                filename1 = path1 +'f'+ str(f) + 'c'+ str(c) + 'b' + str(b)  + '.tiff'
                filename2 = path2 + 'f'+ str(f) + 'c'+ str(c) + 'b' + str(b)  + '.tiff'
