...
path1 = "/home/marie-pierre/Documents/PhD/ants_trophallaxis/exp_setup/setup_output/tests_default_params/upper/upper_test_white_balance/"
path2 = "/home/marie-pierre/Documents/PhD/ants_trophallaxis/exp_setup/setup_output/tests_default_params/lower/lower_test_swhite_balance/"
...
white = [4000, 4500, 5000, 5500, 6000, 6500, 7000] # 0 means infinite
...
#    cap3 = cv2.VideoCapture(2)
    ...
    cap1.set(cv2.CAP_PROP_WHITE_BALANCE_BLUE_U, w)
    ...
    cap2.set(cv2.CAP_PROP_WHITE_BALANCE_BLUE_U, w)
...
#    cap3.set(cv2.CAP_PROP_FOCUS,f)
    ...
    while(True):
        ...
        filename1 = path1 + str(w)  + '.tiff'
        filename2 = path2 + str(w)  + '.tiff'
#        filename3 = path3 + str(f)  + '.tiff'


        print(filename1)
        print(cap1.get(cv2.CAP_PROP_WHITE_BALANCE_BLUE_U))
        print(cap2.get(cv2.CAP_PROP_WHITE_BALANCE_BLUE_U))
